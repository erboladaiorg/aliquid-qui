...
<a href="https://opencollective.com/@erboladaiorg/aliquid-qui#backers" target="_blank"><img src="https://opencollective.com/@erboladaiorg/aliquid-qui/backers.svg?width=890"></a>
...
Now it's deprecated in favor of separate inclusion of required parts of `@erboladaiorg/aliquid-qui` and `regenerator-runtime` and, for preventing breaking changes, left on `@erboladaiorg/aliquid-qui@2`.
...
```
Modules [`es.number.epsilon`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.number.epsilon.js), [`es.number.is-finite`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.number.is-finite.js), [`es.number.is-integer`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.number.is-integer.js), [`es.number.is-nan`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.number.is-nan.js), [`es.number.is-safe-integer`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.number.is-safe-integer.js), [`es.number.max-safe-integer`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.number.max-safe-integer.js), [`es.number.min-safe-integer`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.number.min-safe-integer.js), [`es.number.parse-float`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.number.parse-float.js), [`es.number.parse-int`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.number.parse-int.js), [`es.number.to-exponential`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.number.to-exponential.js), [`es.number.to-fixed`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.number.to-fixed.js), [`es.number.to-precision`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.number.to-precision.js), [`es.parse-int`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.parse-int.js), [`es.parse-float`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.parse-float.js).
```js
class Number {
...
Modules [`es.symbol`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.symbol.js), [`es.symbol.async-iterator`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.symbol.async-iterator.js), [`es.symbol.description`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.symbol.description.js), [`es.symbol.has-instance`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.symbol.has-instance.js), [`es.symbol.is-concat-spreadable`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.symbol.is-concat-spreadable.js), [`es.symbol.iterator`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.symbol.iterator.js), [`es.symbol.match`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.symbol.match.js), [`es.symbol.replace`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.symbol.replace.js), [`es.symbol.search`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.symbol.search.js), [`es.symbol.species`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.symbol.species.js), [`es.symbol.split`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.symbol.split.js), [`es.symbol.to-primitive`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.symbol.to-primitive.js), [`es.symbol.to-string-tag`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.symbol.to-string-tag.js), [`es.symbol.unscopables`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.symbol.unscopables.js), [`es.math.to-string-tag`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.math.to-string-tag.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/symbol
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/symbol/async-iterator
@erboladaiorg/aliquid-qui/es|stable|actual|full/symbol/description
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/symbol/has-instance
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/symbol/is-concat-spreadable
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/symbol/iterator
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/symbol/match
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/symbol/replace
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/symbol/search
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/symbol/species
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/symbol/split
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/symbol/to-primitive
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/symbol/to-string-tag
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/symbol/unscopables
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/symbol/for
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/symbol/key-for
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/object/get-own-property-symbols
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/math/to-string-tag
```
...
```
- Currently, `@erboladaiorg/aliquid-qui` does not add setters to `Object.prototype` for well-known symbols for correct work something like `Symbol.iterator in foo`. It can cause problems with their enumerability.
- Some problems are possible with environment exotic objects (for example, IE `localStorage`).

#### ECMAScript: Collections[⬆](#index)
`@erboladaiorg/aliquid-qui` uses native collections in most cases, just fixes methods / constructor, if it's required, and in the old environment uses fast polyfill (O(1) lookup).
#### Map[⬆](#index)
Modules [`es.map`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.map.js) and [`es.map.group-by`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.map.group-by.js).
```js
class Map {
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/map
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/map/group-by
```
...
```
#### Set[⬆](#index)
Modules [`es.set`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.set.js), [`es.set.difference.v2`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.set.difference.v2.js), [`es.set.intersection.v2`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.set.intersection.v2.js), [`es.set.is-disjoint-from.v2`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.set.is-disjoint-from.v2.js), [`es.set.is-subset-of.v2`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.set.is-subset-of.v2.js), [`es.set.is-superset-of.v2`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.set.is-superset-of.v2.js), [`es.set.symmetric-difference.v2`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.set.symmetric-difference.v2.js), [`es.set.union.v2`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.set.union.v2.js)
```js
class Set {
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/set
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/set/difference
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/set/intersection
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/set/is-disjoint-from
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/set/is-subset-of
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/set/is-superset-of
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/set/symmetric-difference
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/set/union
```
...
```
#### WeakMap[⬆](#index)
Module [`es.weak-map`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.weak-map.js).
```js
class WeakMap {
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/weak-map
```
...
```
#### WeakSet[⬆](#index)
Module [`es.weak-set`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.weak-set.js).
```js
class WeakSet {
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/weak-set
```
...
Modules [`es.array-buffer.constructor`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.array-buffer.constructor.js), [`es.array-buffer.is-view`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.array-buffer.is-view.js), [`esnext.array-buffer.detached`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.array-buffer.detached.js), [`es.array-buffer.slice`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.array-buffer.slice.js), [`esnext.array-buffer.transfer`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.array-buffer.transfer.js), [`esnext.array-buffer.transfer-to-fixed-length`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.array-buffer.transfer-to-fixed-length.js) [`es.data-view`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.data-view.js), [`es.typed-array.int8-array`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.int8-array.js), [`es.typed-array.uint8-array`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.uint8-array.js), [`es.typed-array.uint8-clamped-array`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.uint8-clamped-array.js), [`es.typed-array.int16-array`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.int16-array.js), [`es.typed-array.uint16-array`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.uint16-array.js), [`es.typed-array.int32-array`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.int32-array.js), [`es.typed-array.uint32-array`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.uint32-array.js), [`es.typed-array.float32-array`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.float32-array.js), [`es.typed-array.float64-array`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.float64-array.js), [`es.typed-array.copy-within`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.copy-within.js), [`es.typed-array.every`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.every.js), [`es.typed-array.fill`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.fill.js), [`es.typed-array.filter`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.filter.js), [`es.typed-array.find`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.find.js), [`es.typed-array.find-index`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.find-index.js), [`es.typed-array.find-last`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.find-last.js), [`es.typed-array.find-last-index`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.find-last-index.js), [`es.typed-array.for-each`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.for-each.js), [`es.typed-array.from`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.from.js), [`es.typed-array.includes`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.includes.js), [`es.typed-array.index-of`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.index-of.js), [`es.typed-array.iterator`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.iterator.js), [`es.typed-array.last-index-of`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.last-index-of.js), [`es.typed-array.map`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.map.js), [`es.typed-array.of`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.of.js), [`es.typed-array.reduce`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.reduce.js), [`es.typed-array.reduce-right`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.reduce-right.js), [`es.typed-array.reverse`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.reverse.js), [`es.typed-array.set`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.set.js), [`es.typed-array.slice`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.slice.js), [`es.typed-array.some`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.some.js), [`es.typed-array.sort`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.sort.js), [`es.typed-array.subarray`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.subarray.js), [`es.typed-array.to-locale-string`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.to-locale-string.js), [`es.typed-array.to-string`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.to-string.js), [`es.typed-array.at`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.at.js), [`es.typed-array.to-reversed`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.to-reversed.js), [`es.typed-array.to-sorted`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.to-sorted.js), [`es.typed-array.with`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.typed-array.with.js).
```js
class ArrayBuffer {
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui/es|stable|actual|full/array-buffer
@erboladaiorg/aliquid-qui/es|stable|actual|full/array-buffer/constructor
@erboladaiorg/aliquid-qui/es|stable|actual|full/array-buffer/is-view
@erboladaiorg/aliquid-qui/es|stable|actual|full/array-buffer/detached
@erboladaiorg/aliquid-qui/es|stable|actual|full/array-buffer/slice
@erboladaiorg/aliquid-qui/es|stable|actual|full/array-buffer/transfer
@erboladaiorg/aliquid-qui/es|stable|actual|full/array-buffer/transfer-to-fixed-length
@erboladaiorg/aliquid-qui/es|stable|actual|full/data-view
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/int8-array
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/uint8-array
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/uint8-clamped-array
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/int16-array
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/uint16-array
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/int32-array
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/uint32-array
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/float32-array
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/float64-array
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/at
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/copy-within
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/entries
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/every
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/fill
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/filter
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/find
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/find-index
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/find-last
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/find-last-index
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/for-each
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/from
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/includes
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/index-of
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/iterator
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/join
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/keys
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/last-index-of
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/map
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/of
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/reduce
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/reduce-right
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/reverse
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/set
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/slice
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/some
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/sort
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/subarray
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/to-locale-string
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/to-reversed
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/to-sorted
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/to-string
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/values
@erboladaiorg/aliquid-qui/es|stable|actual|full/typed-array/with
```
...
Modules [`es.reflect.apply`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.reflect.apply.js), [`es.reflect.construct`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.reflect.construct.js), [`es.reflect.define-property`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.reflect.define-property.js), [`es.reflect.delete-property`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.reflect.delete-property.js), [`es.reflect.get`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.reflect.get.js), [`es.reflect.get-own-property-descriptor`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.reflect.get-own-property-descriptor.js), [`es.reflect.get-prototype-of`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.reflect.get-prototype-of.js), [`es.reflect.has`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.reflect.has.js), [`es.reflect.is-extensible`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.reflect.is-extensible.js), [`es.reflect.own-keys`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.reflect.own-keys.js), [`es.reflect.prevent-extensions`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.reflect.prevent-extensions.js), [`es.reflect.set`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.reflect.set.js), [`es.reflect.set-prototype-of`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.reflect.set-prototype-of.js).
```js
namespace Reflect {
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/reflect
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/reflect/apply
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/reflect/construct
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/reflect/define-property
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/reflect/delete-property
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/reflect/get
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/reflect/get-own-property-descriptor
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/reflect/get-prototype-of
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/reflect/has
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/reflect/is-extensible
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/reflect/own-keys
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/reflect/prevent-extensions
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/reflect/set
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/reflect/set-prototype-of
```
...
Since `JSON` object is missed only in very old engines like IE7-, `@erboladaiorg/aliquid-qui` does not provide a full `JSON` polyfill, however, fix already existing implementations by the current standard, for example, [well-formed `JSON.stringify`](https://github.com/tc39/proposal-well-formed-stringify). `JSON` is also fixed in other modules - for example, `Symbol` polyfill fixes `JSON.stringify` for correct work with symbols.

Module [`es.json.to-string-tag`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.json.to-string-tag.js) and [`es.json.stringify`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.json.stringify.js).
```js
namespace JSON {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/json/stringify
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/json/to-string-tag
```
...
Module [`es.global-this`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/es.global-this.js).
```js
let globalThis: GlobalThisValue;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/global-this
```
...
Finished (stage 4) proposals already marked in `@erboladaiorg/aliquid-qui` as stable ECMAScript, they are available in `@erboladaiorg/aliquid-qui/stable` and `@erboladaiorg/aliquid-qui/es` namespace, you can find them in related sections of the README. However, even for finished proposals, `@erboladaiorg/aliquid-qui` provides a way to include only features for a specific proposal like `@erboladaiorg/aliquid-qui/proposals/proposal-name`.
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/global-this
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui/proposals/relative-indexing-method
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui/proposals/array-includes
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui/proposals/array-flat-map
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui/proposals/array-find-from-last
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui/proposals/change-array-by-copy-stage-4
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/array(/virtual)/to-reversed
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/array(/virtual)/to-sorted
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/array(/virtual)/to-spliced
@erboladaiorg/aliquid-qui(-pure)/es|stable|actual|full/array(/virtual)/with
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui/proposals/array-grouping-v2
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/array-buffer-transfer
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui/proposals/object-values-entries
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui/proposals/object-from-entries
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui/proposals/object-getownpropertydescriptors
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui/proposals/accessible-object-hasownproperty
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui/proposals/string-padding
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/string-match-all
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/string-replace-all-stage-4
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/string-left-right-trim
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/regexp-dotall-flag
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/regexp-named-groups
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/promise-all-settled
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/promise-any
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/promise-finally
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/promise-with-resolvers
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/async-iteration
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/symbol-description
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/well-formed-stringify
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/well-formed-unicode-strings
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/set-methods-v2
```

#### Stage 3 proposals[⬆](#index)

`@erboladaiorg/aliquid-qui/stage/3` entry point contains only stage 3 proposals, `@erboladaiorg/aliquid-qui/stage/2.7` - stage 2.7 and stage 3, etc.

[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui(-pure)/stage/3
```
##### [`Iterator` helpers](https://github.com/tc39/proposal-iterator-helpers)[⬆](#index)
Modules [`esnext.iterator.constructor`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.iterator.constructor.js), [`esnext.iterator.drop`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.iterator.drop.js), [`esnext.iterator.every`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.iterator.every.js), [`esnext.iterator.filter`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.iterator.filter.js), [`esnext.iterator.find`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.iterator.find.js), [`esnext.iterator.flat-map`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.iterator.flat-map.js), [`esnext.iterator.for-each`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.iterator.for-each.js), [`esnext.iterator.from`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.iterator.from.js), [`esnext.iterator.map`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.iterator.map.js), [`esnext.iterator.reduce`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.iterator.reduce.js), [`esnext.iterator.some`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.iterator.some.js), [`esnext.iterator.take`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.iterator.take.js), [`esnext.iterator.to-array`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.iterator.to-array.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/iterator-helpers-stage-3-2
@erboladaiorg/aliquid-qui(-pure)/actual|full/iterator
@erboladaiorg/aliquid-qui(-pure)/actual|full/iterator/drop
@erboladaiorg/aliquid-qui(-pure)/actual|full/iterator/every
@erboladaiorg/aliquid-qui(-pure)/actual|full/iterator/filter
@erboladaiorg/aliquid-qui(-pure)/actual|full/iterator/find
@erboladaiorg/aliquid-qui(-pure)/actual|full/iterator/flat-map
@erboladaiorg/aliquid-qui(-pure)/actual|full/iterator/for-each
@erboladaiorg/aliquid-qui(-pure)/actual|full/iterator/from
@erboladaiorg/aliquid-qui(-pure)/actual|full/iterator/map
@erboladaiorg/aliquid-qui(-pure)/actual|full/iterator/reduce
@erboladaiorg/aliquid-qui(-pure)/actual|full/iterator/some
@erboladaiorg/aliquid-qui(-pure)/actual|full/iterator/take
@erboladaiorg/aliquid-qui(-pure)/actual|full/iterator/to-array
```
...
Modules [`esnext.array.from-async`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.array.from-async.js).
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/array-from-async-stage-2
@erboladaiorg/aliquid-qui(-pure)/actual|full/array/from-async
```
...
Modules [`esnext.json.is-raw-json`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.json.is-raw-json.js), [`esnext.json.parse`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.json.parse.js), [`esnext.json.raw-json`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.json.raw-json.js).
```js
namespace JSON {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/json-parse-with-source
@erboladaiorg/aliquid-qui(-pure)/actual|full/json/is-raw-json
@erboladaiorg/aliquid-qui(-pure)/actual|full/json/parse
@erboladaiorg/aliquid-qui(-pure)/actual|full/json/raw-json
@erboladaiorg/aliquid-qui(-pure)/actual|full/json/stringify
```
...
Modules [`esnext.data-view.get-float16`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.data-view.get-float16.js), [`esnext.data-view.set-float16`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.data-view.set-float16.js) and [`esnext.math.f16round`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.math.f16round.js)
```js
class DataView {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/float16
@erboladaiorg/aliquid-qui/actual|full/dataview/get-float16
@erboladaiorg/aliquid-qui/actual|full/dataview/set-float16
@erboladaiorg/aliquid-qui/actual|full/math/f16round
```
...
Modules [`esnext.uint8-array.from-base64`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.uint8-array.from-base64.js), [`esnext.uint8-array.from-hex`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.uint8-array.from-hex.js), [`esnext.uint8-array.to-base64`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.uint8-array.to-base64.js), [`esnext.uint8-array.to-hex`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.uint8-array.to-hex.js).
```js
class Uint8Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/array-buffer-base64
@erboladaiorg/aliquid-qui(-pure)/full/typed-array/from-base64
@erboladaiorg/aliquid-qui(-pure)/full/typed-array/from-hex
@erboladaiorg/aliquid-qui(-pure)/full/typed-array/to-base64
@erboladaiorg/aliquid-qui(-pure)/full/typed-array/to-hex
```
*Example*:
```js
...
Modules [`esnext.symbol.dispose`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.symbol.dispose.js), [`esnext.disposable-stack.constructor`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.disposable-stack.constructor.js), [`esnext.suppressed-error.constructor`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.suppressed-error.constructor.js), [`esnext.iterator.dispose`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.iterator.dispose.js), [`esnext.symbol.async-dispose`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.symbol.async-dispose.js), [`esnext.async-disposable-stack.constructor`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.async-disposable-stack.constructor.js), [`esnext.async-iterator.async-dispose`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.async-iterator.async-dispose.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/explicit-resource-management
@erboladaiorg/aliquid-qui(-pure)/actual|full/symbol/async-dispose
@erboladaiorg/aliquid-qui(-pure)/actual|full/symbol/dispose
@erboladaiorg/aliquid-qui(-pure)/actual|full/disposable-stack
@erboladaiorg/aliquid-qui(-pure)/actual|full/async-disposable-stack
@erboladaiorg/aliquid-qui(-pure)/actual|full/suppressed-error
@erboladaiorg/aliquid-qui(-pure)/actual|full/iterator/dispose
@erboladaiorg/aliquid-qui(-pure)/actual|full/async-iterator/async-dispose
```
##### [`Symbol.metadata` for decorators metadata proposal](https://github.com/tc39/proposal-decorator-metadata)[⬆](#index)
Modules [`esnext.symbol.metadata`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.symbol.metadata.js) and [`esnext.function.metadata`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.function.metadata.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui/proposals/decorator-metadata-v2
@erboladaiorg/aliquid-qui(-pure)/actual|full/symbol/metadata
@erboladaiorg/aliquid-qui(-pure)/actual|full/function/metadata
```

#### Stage 2.7 proposals[⬆](#index)
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui(-pure)/stage/2.7
```

##### [`Promise.try`](https://github.com/tc39/proposal-promise-try)
Module [`esnext.promise.try`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.promise.try.js)
```js
class Promise {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/promise-try
@erboladaiorg/aliquid-qui(-pure)/full/promise/try
```
...
Module [`esnext.math.sum-precise`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.math.sum-precise.js)
```js
class Math {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/math-sum
@erboladaiorg/aliquid-qui(-pure)/full/math/sum-precise
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui(-pure)/stage/2
```
##### [`AsyncIterator` helpers](https://github.com/tc39/proposal-async-iterator-helpers)[⬆](#index)
Modules [`esnext.async-iterator.constructor`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.async-iterator.constructor.js), [`esnext.async-iterator.drop`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.async-iterator.drop.js), [`esnext.async-iterator.every`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.async-iterator.every.js), [`esnext.async-iterator.filter`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.async-iterator.filter.js), [`esnext.async-iterator.find`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.async-iterator.find.js), [`esnext.async-iterator.flat-map`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.async-iterator.flat-map.js), [`esnext.async-iterator.for-each`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.async-iterator.for-each.js), [`esnext.async-iterator.from`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.async-iterator.from.js), [`esnext.async-iterator.map`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.async-iterator.map.js), [`esnext.async-iterator.reduce`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.async-iterator.reduce.js), [`esnext.async-iterator.some`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.async-iterator.some.js), [`esnext.async-iterator.take`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.async-iterator.take.js), [`esnext.async-iterator.to-array`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.async-iterator.to-array.js), , [`esnext.iterator.to-async`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.iterator.to-async.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/async-iterator-helpers
@erboladaiorg/aliquid-qui(-pure)/actual|full/async-iterator
@erboladaiorg/aliquid-qui(-pure)/actual|full/async-iterator/drop
@erboladaiorg/aliquid-qui(-pure)/actual|full/async-iterator/every
@erboladaiorg/aliquid-qui(-pure)/actual|full/async-iterator/filter
@erboladaiorg/aliquid-qui(-pure)/actual|full/async-iterator/find
@erboladaiorg/aliquid-qui(-pure)/actual|full/async-iterator/flat-map
@erboladaiorg/aliquid-qui(-pure)/actual|full/async-iterator/for-each
@erboladaiorg/aliquid-qui(-pure)/actual|full/async-iterator/from
@erboladaiorg/aliquid-qui(-pure)/actual|full/async-iterator/map
@erboladaiorg/aliquid-qui(-pure)/actual|full/async-iterator/reduce
@erboladaiorg/aliquid-qui(-pure)/actual|full/async-iterator/some
@erboladaiorg/aliquid-qui(-pure)/actual|full/async-iterator/take
@erboladaiorg/aliquid-qui(-pure)/actual|full/async-iterator/to-array
@erboladaiorg/aliquid-qui(-pure)/actual|full/iterator/to-async
```
...
- Now, we have access to the real `%AsyncIteratorPrototype%` only with usage async generators syntax. So, for compatibility of the library with old browsers, we should use `Function` constructor. However, that breaks compatibility with CSP. So, if you wanna use the real `%AsyncIteratorPrototype%`, you should set `USE_FUNCTION_CONSTRUCTOR` option in the `@erboladaiorg/aliquid-qui/configurator` to `true`:
```js
const configurator = require('@erboladaiorg/aliquid-qui/configurator');

configurator({ USE_FUNCTION_CONSTRUCTOR: true });

require('@erboladaiorg/aliquid-qui/actual/async-iterator');

(async function * () { /* empty */ })() instanceof AsyncIterator; // => true
```
- As an alternative, you could pass to the `@erboladaiorg/aliquid-qui/configurator` an object that will be considered as `%AsyncIteratorPrototype%`:
```js
const configurator = require('@erboladaiorg/aliquid-qui/configurator');
...
Module [`esnext.iterator.range`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.iterator.range.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/number-range
@erboladaiorg/aliquid-qui(-pure)/full/iterator/range
```
...
Modules [`esnext.map.emplace`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.emplace.js) and [`esnext.weak-map.emplace`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.weak-map.emplace.js)
```js
class Map {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/map-upsert-stage-2
@erboladaiorg/aliquid-qui(-pure)/full/map/emplace
@erboladaiorg/aliquid-qui(-pure)/full/weak-map/emplace
```
...
Module [`esnext.array.is-template-object`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.array.is-template-object.js)
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/array-is-template-object
@erboladaiorg/aliquid-qui(-pure)/full/array/is-template-object
```
*Example*:
```js
...
Module [`esnext.string.dedent`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.string.dedent.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/string-dedent
@erboladaiorg/aliquid-qui(-pure)/full/string/dedent
```
...
Module [`esnext.regexp.escape`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.regexp.escape.js)
```js
class RegExp {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/regexp-escaping
@erboladaiorg/aliquid-qui(-pure)/full/regexp/escape
```
...
Modules [`esnext.symbol.is-registered-symbol`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.symbol.is-registered-symbol.js), [`esnext.symbol.is-well-known-symbol`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.symbol.is-well-known-symbol.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/symbol-predicates-v2
@erboladaiorg/aliquid-qui(-pure)/full/symbol/is-registered-symbol
@erboladaiorg/aliquid-qui(-pure)/full/symbol/is-well-known-symbol
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui(-pure)/stage/1
```
##### [`Observable`](https://github.com/zenparsing/es-observable)[⬆](#index)
Modules [`esnext.observable`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.observable.js) and [`esnext.symbol.observable`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.symbol.observable.js)
```js
class Observable {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/observable
@erboladaiorg/aliquid-qui(-pure)/full/observable
@erboladaiorg/aliquid-qui(-pure)/full/symbol/observable
```
...
Modules [`esnext.set.add-all`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.set.add-all.js), [`esnext.set.delete-all`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.set.delete-all.js), [`esnext.set.every`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.set.every.js), [`esnext.set.filter`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.set.filter.js), [`esnext.set.find`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.set.find.js), [`esnext.set.join`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.set.join.js), [`esnext.set.map`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.set.map.js), [`esnext.set.reduce`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.set.reduce.js), [`esnext.set.some`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.set.some.js), [`esnext.map.delete-all`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.delete-all.js), [`esnext.map.every`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.every.js), [`esnext.map.filter`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.filter.js), [`esnext.map.find`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.find.js), [`esnext.map.find-key`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.find-key.js), [`esnext.map.includes`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.includes.js), [`esnext.map.key-by`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.key-by.js), [`esnext.map.key-of`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.key-of.js), [`esnext.map.map-keys`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.map-keys.js), [`esnext.map.map-values`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.map-values.js), [`esnext.map.merge`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.merge.js), [`esnext.map.reduce`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.reduce.js), [`esnext.map.some`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.some.js), [`esnext.map.update`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.update.js), [`esnext.weak-set.add-all`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.weak-set.add-all.js), [`esnext.weak-set.delete-all`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.weak-set.delete-all.js), [`esnext.weak-map.delete-all`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.weak-map.delete-all.js)
##### [`.of` and `.from` methods on collection constructors](https://github.com/tc39/proposal-setmap-offrom)[⬆](#index)
Modules [`esnext.set.of`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.set.of.js), [`esnext.set.from`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.set.from.js), [`esnext.map.of`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.of.js), [`esnext.map.from`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.map.from.js), [`esnext.weak-set.of`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.weak-set.of.js), [`esnext.weak-set.from`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.weak-set.from.js), [`esnext.weak-map.of`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.weak-map.of.js), [`esnext.weak-map.from`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.weak-map.from.js)
```js
class Set {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/collection-methods
@erboladaiorg/aliquid-qui/proposals/collection-of-from
@erboladaiorg/aliquid-qui(-pure)/full/set/add-all
@erboladaiorg/aliquid-qui(-pure)/full/set/delete-all
@erboladaiorg/aliquid-qui(-pure)/full/set/every
@erboladaiorg/aliquid-qui(-pure)/full/set/filter
@erboladaiorg/aliquid-qui(-pure)/full/set/find
@erboladaiorg/aliquid-qui(-pure)/full/set/from
@erboladaiorg/aliquid-qui(-pure)/full/set/join
@erboladaiorg/aliquid-qui(-pure)/full/set/map
@erboladaiorg/aliquid-qui(-pure)/full/set/of
@erboladaiorg/aliquid-qui(-pure)/full/set/reduce
@erboladaiorg/aliquid-qui(-pure)/full/set/some
@erboladaiorg/aliquid-qui(-pure)/full/map/delete-all
@erboladaiorg/aliquid-qui(-pure)/full/map/every
@erboladaiorg/aliquid-qui(-pure)/full/map/filter
@erboladaiorg/aliquid-qui(-pure)/full/map/find
@erboladaiorg/aliquid-qui(-pure)/full/map/find-key
@erboladaiorg/aliquid-qui(-pure)/full/map/from
@erboladaiorg/aliquid-qui(-pure)/full/map/includes
@erboladaiorg/aliquid-qui(-pure)/full/map/key-by
@erboladaiorg/aliquid-qui(-pure)/full/map/key-of
@erboladaiorg/aliquid-qui(-pure)/full/map/map-keys
@erboladaiorg/aliquid-qui(-pure)/full/map/map-values
@erboladaiorg/aliquid-qui(-pure)/full/map/merge
@erboladaiorg/aliquid-qui(-pure)/full/map/of
@erboladaiorg/aliquid-qui(-pure)/full/map/reduce
@erboladaiorg/aliquid-qui(-pure)/full/map/some
@erboladaiorg/aliquid-qui(-pure)/full/map/update
@erboladaiorg/aliquid-qui(-pure)/full/weak-set/add-all
@erboladaiorg/aliquid-qui(-pure)/full/weak-set/delete-all
@erboladaiorg/aliquid-qui(-pure)/full/weak-set/of
@erboladaiorg/aliquid-qui(-pure)/full/weak-set/from
@erboladaiorg/aliquid-qui(-pure)/full/weak-map/delete-all
@erboladaiorg/aliquid-qui(-pure)/full/weak-map/of
@erboladaiorg/aliquid-qui(-pure)/full/weak-map/from
```
...
Modules [`esnext.composite-key`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.composite-key.js) and [`esnext.composite-symbol`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.composite-symbol.js)
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/keys-composition
@erboladaiorg/aliquid-qui(-pure)/full/composite-key
@erboladaiorg/aliquid-qui(-pure)/full/composite-symbol
```
...
Modules [`esnext.array.filter-reject`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.array.filter-reject.js) and [`esnext.typed-array.filter-reject`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.typed-array.filter-reject.js).
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui/proposals/array-filtering-stage-1
@erboladaiorg/aliquid-qui(-pure)/full/array(/virtual)/filter-reject
@erboladaiorg/aliquid-qui/full/typed-array/filter-reject
```
...
Modules [`esnext.array.unique-by`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.array.unique-by.js) and [`esnext.typed-array.unique-by`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.typed-array.unique-by.js)
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui/proposals/array-unique
@erboladaiorg/aliquid-qui(-pure)/full/array(/virtual)/unique-by
@erboladaiorg/aliquid-qui/full/typed-array/unique-by
```
...
Modules [`esnext.data-view.get-uint8-clamped`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.data-view.get-uint8-clamped.js) and [`esnext.data-view.set-uint8-clamped`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.data-view.set-uint8-clamped.js)
```js
class DataView {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/data-view-get-set-uint8-clamped
@erboladaiorg/aliquid-qui/full/dataview/get-uint8-clamped
@erboladaiorg/aliquid-qui/full/dataview/set-uint8-clamped
```
...
Module [`esnext.number.from-string`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.number.from-string.js)
```js
class Number {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/number-from-string
@erboladaiorg/aliquid-qui(-pure)/full/number/from-string
```

##### [`String.cooked`](https://github.com/tc39/proposal-string-cooked)[⬆](#index)
Module [`esnext.string.cooked`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.string.cooked.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/string-cooked
@erboladaiorg/aliquid-qui(-pure)/full/string/cooked
```
...
Module [`esnext.string.code-points`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.string.code-points.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/string-code-points
@erboladaiorg/aliquid-qui(-pure)/full/string/code-points
```
[*Example*](https://goo.gl/Jt7SsD):
```js
...
Module [`esnext.symbol.custom-matcher`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.symbol.custom-matcher.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/pattern-matching-v2
@erboladaiorg/aliquid-qui(-pure)/full/symbol/custom-matcher
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/pattern-extractors
@erboladaiorg/aliquid-qui(-pure)/full/symbol/custom-matcher
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui(-pure)/stage/0
```
##### [`Function.prototype.demethodize`](https://github.com/js-choi/proposal-function-demethodize)[⬆](#index)
Module [`esnext.function.demethodize`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.function.demethodize.js)
```js
class Function {
...
[*CommonJS entry points:*](#commonjs-api)
```
@erboladaiorg/aliquid-qui/proposals/function-demethodize
@erboladaiorg/aliquid-qui(-pure)/full/function/demethodize
@erboladaiorg/aliquid-qui(-pure)/full/function/virtual/demethodize
```
...
Modules [`esnext.function.is-callable`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.function.is-callable.js), [`esnext.function.is-constructor`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.function.is-constructor.js)
```js
class Function {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/function-is-callable-is-constructor
@erboladaiorg/aliquid-qui(-pure)/full/function/is-callable
@erboladaiorg/aliquid-qui(-pure)/full/function/is-constructor
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui(-pure)/stage/pre
```
##### [`Reflect` metadata](https://github.com/rbuckton/reflect-metadata)[⬆](#index)
Modules [`esnext.reflect.define-metadata`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.reflect.define-metadata.js), [`esnext.reflect.delete-metadata`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.reflect.delete-metadata.js), [`esnext.reflect.get-metadata`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.reflect.get-metadata.js), [`esnext.reflect.get-metadata-keys`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.reflect.get-metadata-keys.js), [`esnext.reflect.get-own-metadata`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.reflect.get-own-metadata.js), [`esnext.reflect.get-own-metadata-keys`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.reflect.get-own-metadata-keys.js), [`esnext.reflect.has-metadata`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.reflect.has-metadata.js), [`esnext.reflect.has-own-metadata`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.reflect.has-own-metadata.js) and [`esnext.reflect.metadata`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/esnext.reflect.metadata.js).
```js
namespace Reflect {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/reflect-metadata
@erboladaiorg/aliquid-qui(-pure)/full/reflect/define-metadata
@erboladaiorg/aliquid-qui(-pure)/full/reflect/delete-metadata
@erboladaiorg/aliquid-qui(-pure)/full/reflect/get-metadata
@erboladaiorg/aliquid-qui(-pure)/full/reflect/get-metadata-keys
@erboladaiorg/aliquid-qui(-pure)/full/reflect/get-own-metadata
@erboladaiorg/aliquid-qui(-pure)/full/reflect/get-own-metadata-keys
@erboladaiorg/aliquid-qui(-pure)/full/reflect/has-metadata
@erboladaiorg/aliquid-qui(-pure)/full/reflect/has-own-metadata
@erboladaiorg/aliquid-qui(-pure)/full/reflect/metadata
```
...
### Web standards[⬆](#index)
#### `self`[⬆](#index)
[Spec](https://html.spec.whatwg.org/multipage/window-object.html#dom-self), module [`web.self`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.self.js)
```js
getter self: GlobalThisValue;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui(-pure)/stable|actual|full/self
```
...
[Spec](https://html.spec.whatwg.org/multipage/structured-data.html#dom-structuredclone), module [`web.structured-clone`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.structured-clone.js)
```js
function structuredClone(value: Serializable, { transfer?: Sequence<Transferable> }): any;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui(-pure)/stable|actual|full/structured-clone
```
...
> - Some specific platform types can't be cloned in old engines. Mainly it's very specific types or very old engines, but here are some exceptions. For example, we have no sync way to clone `ImageBitmap` in Safari 14.0- or Firefox 83-, so it's recommended to look to the [polyfill source](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.structured-clone.js) if you wanna clone something specific.

#### Base64 utility methods[⬆](#index)
[Specification](https://html.spec.whatwg.org/multipage/webappapis.html#atob), [MDN](https://developer.mozilla.org/en-US/docs/Glossary/Base64). Modules [`web.atob`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.atob.js), [`web.btoa`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.btoa.js).
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui(-pure)/stable|actual|full/atob
@erboladaiorg/aliquid-qui(-pure)/stable|actual|full/btoa
```
[*Examples*](https://is.gd/4Nxmzn):
```js
btoa('hi, @erboladaiorg/aliquid-qui');      // => 'aGksIGNvcmUtanM='
atob('aGksIGNvcmUtanM='); // => 'hi, @erboladaiorg/aliquid-qui'
```

#### `setTimeout` and `setInterval`[⬆](#index)
Module [`web.timers`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.timers.js). Additional arguments fix for IE9-.
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui(-pure)/stable|actual|full/set-timeout
@erboladaiorg/aliquid-qui(-pure)/stable|actual|full/set-interval
```
```js
// Before:
...
```
#### `setImmediate`[⬆](#index)
Module [`web.immediate`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.immediate.js). [`setImmediate`](https://w3c.github.io/setImmediate/) polyfill.
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui(-pure)/stable|actual|full/set-immediate
@erboladaiorg/aliquid-qui(-pure)/stable|actual|full/clear-immediate
```
...
[Spec](https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#dom-queuemicrotask), module [`web.queue-microtask`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.queue-microtask.js)
```js
function queueMicrotask(fn: Function): void;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui(-pure)/stable|actual|full/queue-microtask
```
...
[`URL` standard](https://url.spec.whatwg.org/) implementation. Modules [`web.url`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.url.js), [`web.url.can-parse`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.url.can-parse.js), [`web.url.parse`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.url.parse.js), [`web.url.to-json`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.url.to-json.js), [`web.url-search-params`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.url-search-params.js), [`web.url-search-params.delete`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.url-search-params.delete.js), [`web.url-search-params.has`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.url-search-params.has.js), [`web.url-search-params.size`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.url-search-params.size.js).
```js
class URL {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui/proposals/url
@erboladaiorg/aliquid-qui(-pure)/stable|actual|full/url
@erboladaiorg/aliquid-qui(-pure)/stable|actual|full/url/can-parse
@erboladaiorg/aliquid-qui/stable|actual|full/url/to-json
@erboladaiorg/aliquid-qui(-pure)/stable|actual|full/url-search-params
```
...
> - Legacy encodings in a search query are not supported. Also, `@erboladaiorg/aliquid-qui` implementation has some other encoding-related issues.
> - `URL` implementations from all of the popular browsers have significantly more problems than `@erboladaiorg/aliquid-qui`, however, replacing all of them does not look like a good idea. You can customize the aggressiveness of polyfill [by your requirements](#configurable-level-of-aggressiveness).

##### `DOMException`:[⬆](#index)
[The specification.](https://webidl.spec.whatwg.org/#idl-DOMException) Modules [`web.dom-exception.constructor`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.dom-exception.constructor.js), [`web.dom-exception.stack`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.dom-exception.stack.js), [`web.dom-exception.to-string-tag`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.dom-exception.to-string-tag.js).
```js
class DOMException {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui(-pure)/stable|actual|full/dom-exception
@erboladaiorg/aliquid-qui(-pure)/stable|actual|full/dom-exception/constructor
@erboladaiorg/aliquid-qui/stable|actual|full/dom-exception/to-string-tag
```
...
Some DOM collections should have [iterable interface](https://heycam.github.io/webidl/#idl-iterable) or should be [inherited from `Array`](https://heycam.github.io/webidl/#LegacyArrayClass). That means they should have `forEach`, `keys`, `values`, `entries` and `@@iterator` methods for iteration. So add them. Modules [`web.dom-collections.iterator`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.dom-collections.iterator.js) and [`web.dom-collections.for-each`](https://github.com/erboladaiorg/aliquid-qui/blob/master/packages/@erboladaiorg/aliquid-qui/modules/web.dom-collections.for-each.js).
```js
class [
  CSSRuleList,
  CSSStyleDeclaration,
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui(-pure)/stable|actual|full/dom-collections/iterator
@erboladaiorg/aliquid-qui/stable|actual|full/dom-collections/for-each
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@erboladaiorg/aliquid-qui-pure/es|stable|actual|full/is-iterable
@erboladaiorg/aliquid-qui-pure/es|stable|actual|full/get-iterator
@erboladaiorg/aliquid-qui-pure/es|stable|actual|full/get-iterator-method
```
[*Examples*](https://goo.gl/SXsM6D):
```js
import isIterable from '@erboladaiorg/aliquid-qui-pure/actual/is-iterable';
import getIterator from '@erboladaiorg/aliquid-qui-pure/actual/get-iterator';
import getIteratorMethod from '@erboladaiorg/aliquid-qui-pure/actual/get-iterator-method';
...
- ES `BigInt` can't be polyfilled since it requires changes in the behavior of operators, you can find more info [here](https://github.com/erboladaiorg/aliquid-qui/issues/381). You could try to use [`JSBI`](https://github.com/GoogleChromeLabs/jsbi).
...
- `window.fetch` is not a cross-platform feature, in some environments, it makes no sense. For this reason, I don't think it should be in `@erboladaiorg/aliquid-qui`. Looking at a large number of requests it *might be*  added in the future. Now you can use, for example, [this polyfill](https://github.com/github/fetch).
